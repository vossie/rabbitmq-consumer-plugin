...
import io.jenkins.plugins.rabbitmqconsumer.utils.Validators;
 ...
 */
@Extension
public class GlobalRabbitmqConfiguration extends GlobalConfiguration {
    ...
    public GlobalRabbitmqConfiguration(boolean enableConsumer, String serviceUri, String credentialsId, long watchdogPeriod, List<RabbitmqConsumeItem> consumeItems, boolean enableDebug) {
    ...
    public static GlobalRabbitmqConfiguration get() {
        return ExtensionList.lookupSingleton(GlobalRabbitmqConfiguration.class);
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GlobalRabbitmqConfiguration)) return false;
        GlobalRabbitmqConfiguration that = (GlobalRabbitmqConfiguration) o;
